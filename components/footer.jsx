      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <span className="text-xl font-bold text-secondary">F2A CARS</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">0927 775 5709</li>
        ...
        <div className="border-t border-muted pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} F2A CARS. All rights reserved.
          </p>
